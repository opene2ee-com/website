export function logoSvg(height = 28) {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 32" height="${height}" fill="none">
    <text x="0" y="24" font-family="'IBM Plex Mono', monospace" font-size="20" font-weight="600" fill="#303055">
      <tspan fill="#767682">&lt;</tspan>OpenE2EE<tspan fill="#767682"> /&gt;</tspan>
    </text>
  </svg>`;
}

export function lockIcon() {
  return `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>`;
}
